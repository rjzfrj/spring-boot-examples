...
public final class RedisUtil {
     ...
     * 每日用户登陆记录
     * */
    public  boolean activeUsers(String action,long user_id){

       return   redisTemplate.opsForValue().setBit(action, user_id,true);
    }
    ...
    public  int uniqueCount(String action, String date) {
        String key = action + "_" + date;


        String  obj= (String) redisTemplate.opsForValue().get(key);
        byte[] s= obj.getBytes();
        BitSet users = BitSet.valueOf(s);
     ...
     * key 的设计原则是每天一个key 格式为 daily_active_users:当日日期
     * */
    public  int uniqueCount(String action, String date,Long uid) {
        String key = action + "_" + date;


        Object obj= redisTemplate.opsForValue().getBit(key,uid);
        byte[] s= obj.toString().getBytes();
        BitSet users = BitSet.valueOf(s);
        return users.cardinality();
    }
    ...
    public  int uniqueCount(String action, String... dates) {
        ...
        for (String date : dates) {
            ...
            Object obj=redisTemplate.opsForValue().get(key.getBytes());
            BitSet users = BitSet.valueOf(obj.toString().getBytes());
            all.or(users);
        }
